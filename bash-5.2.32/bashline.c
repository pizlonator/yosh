...
#  endif
  ...
  /* Enable LLM "yo" features for yosh */
  {
    static const char *yo_documentation =
      ...
      "- `key` - Your API key. For local LLMs like ollama, use `key dummy`.\n"
      "- `model` - The model to use.\n"
      "  Defaults: `claude-sonnet-4-5-20250929` for Anthropic, `gpt-4o-mini` for OpenAI.\n"
      "- `base_url` - Custom API base URL for compatible endpoints (e.g. ollama, vLLM).\n"
      ...
      "\n"
      "- `token_budget` - Maximum estimated tokens for conversation history.\n"
      ...
      "For local LLMs like ollama, use `key dummy` in ~/.yoconf.\n"
      "\n"
      "### 'must have mode 0600'\n"
      ...
      "base_url, chat_prefix, chat_reset, history_limit, token_budget, scrollback_enabled,\n"
      "scrollback_bytes, scrollback_lines, server_web. Lines starting with # are comments.\n"
      "\n"
      "### 'API error: ...' messages\n"
