...
#  endif
  ...
  /* Enable LLM "yo" features for yosh */
  {
    static const char *yo_documentation =
      ...
      "#### Directives\n"
      "\n"
      "- `provider` - The LLM provider: `anthropic`, `openai`, or `kimi`.\n"
      "- `key` - Your API key.\n"
      ...
      "or create ~/.anthropickey, ~/.openaikey, or ~/.kimikey (mode 0600) with your API key.\n"
      "\n"
      "### 'must have mode 0600'\n"
      ...
      "chat_prefix, color_prefix, chat_reset, color_reset, history_limit, token_budget,\n"
      "scrollback_enabled, scrollback_bytes, scrollback_lines, server_web, enable_italic,\n"
      "disable_italic, enable_bold, disable_bold, enable_strikethrough,\n"
      "disable_strikethrough, code_delimiter. Lines starting with # are comments.\n"
      "\n"
      "### 'API error: ...' messages\n"
      ...
      "- Supported providers: Anthropic (Claude), OpenAI (GPT), and Kimi\n"
