...
#  endif
  ...
  /* Enable LLM "yo" features for yosh */
  {
    static const char *yo_documentation =
      ...
      "- `chat_prefix` - String printed before chat/error output.\n"
      "  Default: `\\033[3;36m` (cyan italic ANSI escape). Set to `\"\"` to disable.\n"
      "- `chat_reset` - String printed after chat/error output.\n"
      "  Default: `\\033[0m` (ANSI reset). Set to `\"\"` to disable.\n"
      "\n"
      "Values for `chat_prefix` and `chat_reset` support C-style escape sequences\n"
      "(e.g. `\\033`, `\\n`, `\\t`, `\\\\`) and optional quoting with `\"` or `'` to\n"
      "preserve whitespace. Without quotes, leading/trailing whitespace is trimmed.\n"
      "\n"
      ...
      "  `~/.anthropickey`, then `~/.yoshkey`, then `~/.openaikey`.\n"
      ...
      "or create ~/.anthropickey or ~/.openaikey (mode 0600) with your API key.\n"
      "\n"
      "### 'must have mode 0600'\n"
